...
import { LogOut, Search, MessageCircle, Eye } from "lucide-react"
          ...
          <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <div className="text-sm">
                <span className="font-bold text-slate-800">Bienvenido,</span> <span className="text-blue-600 font-bold hover:underline decoration-blue-200 underline-offset-4 cursor-pointer">{employeeName}</span>
              </div>
        ...
        <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
          ...
          <div className="bg-slate-100 rounded-xl p-4 flex flex-col md:flex-row items-center gap-4 border border-slate-200 shadow-sm">
            <div className="flex-1 w-full flex items-center gap-4">
              ...
              <div className="relative flex-1 group">
                ...
                <input type="text" placeholder="Búsqueda por Palabra Clave" className="w-full pl-10 pr-4 py-2.5 text-sm rounded-lg border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 outline-none transition-all text-slate-700 bg-white placeholder:text-slate-400 shadow-sm" />
              </div>
            </div>
                    ...
                    >
                      ...
                      <TableCell className="text-right pr-6">
                        <div className="flex justify-end gap-2 text-slate-400">
                          <button className="hover:text-blue-600 hover:bg-blue-50 transition-all p-2 rounded-lg group/btn hover:shadow-sm ring-1 ring-transparent hover:ring-blue-100">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center py-4 gap-6 border-t border-slate-200/60 mt-8">
            <div className="flex items-center gap-6 text-sm font-bold text-slate-400 select-none">
              <button className="hover:text-blue-600 hover:bg-blue-50 px-3 py-1.5 rounded-md transition-all flex items-center  disabled:opacity-50">&lt; Anterior</button>
              <div className="flex gap-2">
                <span className="bg-blue-600 text-white w-8 h-8 flex items-center justify-center rounded-lg shadow-md shadow-blue-200">1</span>
                <span className="hover:bg-slate-100 hover:text-blue-600 w-8 h-8 flex items-center justify-center rounded-lg cursor-pointer transition-colors">2</span>
                <span className="hover:bg-slate-100 hover:text-blue-600 w-8 h-8 flex items-center justify-center rounded-lg cursor-pointer transition-colors">3</span>
              </div>
              <button className="hover:text-blue-600 hover:bg-blue-50 px-3 py-1.5 rounded-md transition-all flex items-center">Siguiente &gt;</button>
              <span className="text-slate-400 font-medium ml-4 text-xs tracking-wide uppercase border-l pl-6 border-slate-200">Mostrando {filteredRequests.length} de 45 registros</span>
            </div>
